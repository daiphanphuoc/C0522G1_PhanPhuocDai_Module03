...
public class UserRepository implements IUserRepository {
    ...
    private static final String SELECT_USER_BY_COUNTRY_SORT = "select id,name,email,country from users  order by name ";
    ...
    public void insertUpdateUseTransaction() {
        try (Connection conn = BaseRepository.getConnection();
            ...
            // below line caused error, test transaction
            // org.postgresql.util.PSQLException: No value specified for parameter 1.
            // psUpdate.setBigDecimal(2, new BigDecimal(999.99));/* demo false transaction*/
    ...
    public List<User> sortByName(String sort) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                users.add(new User(id, name, email, coun));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
